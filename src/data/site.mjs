...
export const site = {
  ...
  brandFull: 'Inginet',
  founded: 2000,
  // ⚠️ SEGNAPOSTO — sostituire prima della pubblicazione
  legal: {
...
export const clients = [
  ...
  { name: 'La Masseria Hotel & SPA', url: 'https://www.lamasseria.info/', logo: 'la-masseria-hotel-spa-logo.png', sector: 'ricettivo', tags: ['gestionale', 'seo'], featured: true },
  ...
  { name: 'PitStop Martano', url: 'https://www.pitstopmartano.it/', logo: 'pitstop-martano-logo.png', sector: 'retail', tags: ['gestionale', 'ordini', 'sito'], featured: true },
